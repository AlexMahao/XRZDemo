...
public class Urls {
    ...
    //主题下事件
    public static String EVENT_LIST = "http://api.xiaorizi.me/api/eventapi/?catid=%s&cityid=101&offset=20&page=1&token_time=%s&app_token=%s&version=2.3.7&channel=c_zhy&uuid=c0c775f4-521c-3073-afdf-a4e4f236a5c5 ";

    //主题列表
    public static String EXPLORE_SPLICAL_LIST="http://api.xiaorizi.me/api/catapi/?lastdate=0&cityid=101&offset=20&page=%s&token_time=%s&app_token=%s&version=2.3.7&channel=c_zhy&uuid=c0c775f4-521c-3073-afdf-a4e4f236a5c5";

    //体验
    public static String BROAD_WOOD = "http://api.xiaorizi.me/api/eventapi/?price_type=1&offset=6&page=%s&cityid=101&token_time=%s&app_token=%s&version=2.3.7&channel=c_zhy&uuid=c0c775f4-521c-3073-afdf-a4e4f236a5c5";
