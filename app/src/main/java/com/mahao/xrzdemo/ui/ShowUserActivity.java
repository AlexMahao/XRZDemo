...
public class ShowUserActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIdTextView.setText(MyApp.user.getObjectId());

        mPhone.setText(MyApp.user.getMobilePhoneNumber());

        //mPassword.setText(user.get);

        mIcon.setText(MyApp.user.getUserIcon() + "");
    }
                    ...
                    try {
                        ...
                        bmobFile.uploadblock(getApplicationContext(), new UploadFileListener() {
                            ...
                            public void onSuccess() {
                                ...
                                MyApp.user.setUserIcon(url);
                                MyApp.user.update(getApplicationContext());
                                dialog.dismiss();
                            }
                            ...
                            public void onFailure(int code, String msg) {
                                // TODO Auto-generated method stub
                                T.show(getApplicationContext(),"上传文件失败：" + msg);
                                dialog.dismiss();
                            }
                        });
